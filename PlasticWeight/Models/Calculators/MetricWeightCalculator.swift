...
struct MetricWeightCalculator: WeightCalculatorType {
    typealias SpecificGravity = Double
    ...
    func calculateSheet(densityMesure: SpecificGravity, thickness: String, width: String, length: String) throws -> Double {
    ...
    /// - Returns: Weight in pounds with four decimal point precision.
    /// - Throws: An error of type CalculationError.
    func calculateRoundRod(densityMesure: SpecificGravity, diameter: String, length: String ) throws -> Double {
    ...
    /// - Returns: Weight in pounds with four decimal point precision.
    /// - Throws: An error of type CalculationError.
    func calculateRoundTube(densityMesure: SpecificGravity, outsideDiameter: String, wall: String, length: String) throws -> Double {
    ...
    /// - Returns: Weight in pounds with four decimal point precision.
    /// - Throws: An error of type CalculationError.
    func calculateSquareTube(densityMesure: SpecificGravity, outsideSquareWidth: String, wall: String, length: String) throws -> Double {
