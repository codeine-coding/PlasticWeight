...
class PlasticManager {
    ...
    init() {
        materials.append(contentsOf: [
            ...
            Plastic(title: "APVC", factor: 0.05, specificGravity: 1.4),
            Plastic(title: "Acetal", factor: 0.051, specificGravity: 1.44),
            Plastic(title: NSLocalizedString("Expanded/Foam PVC (FPVC)", comment: "Expanded/Foam PVC (FPVC)"), factor: 0.028, specificGravity: 0.58),
            Plastic(title: "UHMW", factor: 0.034, specificGravity: 0.93),
            Plastic(title: "HDPE", factor: 0.036, specificGravity: 0.965),
            Plastic(title: "LDPE", factor: 0.034, specificGravity: 0.925),
            Plastic(title: "PVC", factor: 0.051, specificGravity: 1.4),
            Plastic(title: NSLocalizedString("Polypropylene", comment: "Polypropylene"), factor: 0.033, specificGravity: 0.905),
            ...
            Plastic(title: "PTFE", factor: 0.078, specificGravity: 2.16),
